// ⚠️ Output format FROZEN by golden tests (statusline_test.go TestStatuslineGolden*) per operator request — 3 breakages on record; change the fixtures deliberately or not at all.
